...
from authentication.views import CustomPasswordResetConfirmView, CustomTokenRefreshView, FourtyTwoLogin
...
urlpatterns = [
    ...
    path(
        ...
        CustomPasswordResetConfirmView.as_view(template_name="index.html"),
